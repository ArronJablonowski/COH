...
func TestPublishedCapabilityMatchesDiscovery(t *testing.T) {
	rig := newTestRig(t)
	fixture, err := os.ReadFile("../../../contracts/provider/vllm/v1/capability.json")
	if err != nil {
		t.Fatal(err)
	}
	...
	if published.Digest() != "sha256:58032ab6924a17192ebdd634bf177da59bbf5baad8eacd1bad150958b37476f5" {
