...
func TestPublishedCapabilityMatchesDiscovery(t *testing.T) {
	rig := newTestRig(t)
	fixture, err := os.ReadFile("../../../contracts/provider/llama-cpp/v1/capability.json")
	if err != nil {
		t.Fatal(err)
	}
	...
	if published.Digest() != "sha256:08ddf44ab37a993e1e908f2cc21a4a20c05bb1b1ab3ce75088bbc83293f821b7" {
...
func TestAdapterPassesProviderNeutralConformanceSuite(t *testing.T) {
	...
	structuredRequest.Tools = []providercontract.Tool{}
	strict := true
